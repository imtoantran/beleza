 ...
 * 
 */
class bookinghistory_model extends Model {
	...
	public function loadClientBookingList() {
		...
		SELECT 
			...
			bd.booking_detail_client_response,
			...
			bd.booking_detail_created,
			bd.booking_detail_updated,
			-- u.user_id,
		...
		FROM 
			...
			user_service us
		WHERE 
				c.client_id = b.booking_client_id
			AND b.booking_id = bd.booking_detail_booking_id
