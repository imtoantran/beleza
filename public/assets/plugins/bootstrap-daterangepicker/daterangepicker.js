...
!function ($) {
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            /* 1/6/2015 5:55:15 PM imtoantran add custome range option */
            if (typeof options.locale == 'object') {
                ...
                if(typeof(options.locale.daysOfWeek) == 'object') this.locale.daysOfWeek = options.locale.daysOfWeek;
                if(typeof(options.locale.monthNames) == 'string') this.locale.monthNames = options.locale.monthNames;
                if(typeof(options.locale.firstDay) == 'string') this.locale.firstDay = options.locale.firstDay;
                if(typeof(options.locale.cancelLabel) == 'string') this.locale.cancelLabel = options.locale.cancelLabel;
            }
            /* 1/6/2015 5:55:15 PM imtoantran add custome option */
