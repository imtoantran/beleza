                    ...
                    <div class="well" style="background-color: #000000">
                        <div class="row" style="font-size: 16px;">
                            ...
                            <div class="col-md-4" style="color: #FFFFFF;">
                                <a style="color: white;" id="link_user_id" href="">
                    ...
                    <div class="col-md-7" data-spy="scroll" data-target="#service_nav" >
                        <div class="row">
                                ...
                                <nav id="service_nav" class="navbar navbar-default" role="navigation">
                                    <div class="">
                                        <ul class="nav navbar-nav">
                                            ...
                                            <li style="font-size: 19px" class="text-center">
                                                <a href="#about_venue"><strong>&nbsp;&nbsp;&nbsp;Thông tin địa điểm&nbsp;&nbsp;&nbsp;</strong></a>
                                            </li>
                                        </ul>
                                    </div>
                                </nav>
                            ...
                            <div class="col-md-12">
                                <div id="detail" class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <span class="service_properties">
                                                <i style="color: #FDBD0E;" class="fa fa-check-square-o"></i><b> Về dịch vụ của chúng tôi</b>
                                                <span>
                                                    </div>
                                                    <div style="margin-top: 15px" class="col-md-12">
                                                        ...
                                                        <p class="user_service_description"></p>
                                                    </div>
                                                    </div>
                                                    <hr />
                                                    <div class="row">
							...
							<div class="col-md-5" style="position: relative">
								<i id="loading_time_booking" style="position: absolute;left: 47%;top:50px;z-index: 1002" class="fa fa-2x fa-spin fa-refresh text-orange"></i>
								<div id="not_allow_when_loading_time_booking" style="position: absolute;width: 100%;height: 100%;z-index: 1001;opacity: 0.5;background-color:#FFFFFF;left: 0%"></div>
                                ...
                                <button class="btn login-face-btn" type="button" onclick="loginFB()">
                                ...
                                <!-- <img class='login-face-btn' src="<?php echo ASSETS; ?>img/fbloginbtn.png" onclick="loginFB()"/> -->
                                                        ...
                                                        <div id="footer-info">
                                                            <div class="container">
                                                                <div id="footer-1" class="col-md-2">
                                                                    ...
                                                                    <p id="newspaper" class="text-orange-black pointer">Góc báo chí</p>
                                                                    <p id="recruit" class="text-orange-black pointer">Tuyển dụng</p>
                                                                </div>
                                                                ...
                                                                <div id="footer-3" class="col-md-2">
                                                                    ...
                                                                    <p id="expert" class="text-orange-black pointer">Góc chuyên gia</p>
                                                                    <p id="total_care" class="text-orange-black pointer">Chăm sóc toàn diện</p>
                                                                    <p id="download_application" class="text-orange-black pointer">Tải ứng dụng</p>
                                                                </div>

                                                                <div id="footer-4" class="col-md-2">
                                                                    <h4><b>DỊCH VỤ</b></h4>
                                                                    <p id="authentication_voucher" class="text-orange-black pointer">Xác thực voucher</p>
                                                                    <p id="regist_venue" class="text-orange-black pointer" onclick="clearCreatePlaceModal()" data-toggle="modal" data-target="#create_place_modal">Đăng ký gian hàng</p>
                                                                    <p id="news" class="text-orange-black pointer">Trang tin</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div id="footer-last">
                                                            ...
                                                            <div class="container" align="center">
                                                                <ul class="list-inline">
                                                                    <li class="pointer twitter" title="Twitter">
                                                                        <span class="fa-stack">
                                                                            <i class="fa fa-circle fa-stack-2x text-white"></i>
                                                                            <i class="fa fa-twitter fa-stack-1x fa-inverse text-orange"></i>                                                                             
                                                                            <span class="mytooltip">Twitter</span> 
                                                                        </span>
                                                                          

                                                                    </li>
                                                                    <li class="pointer facebook">
                                                                        <span class="fa-stack">
                                                                            <i class="fa fa-circle fa-stack-2x text-white"></i>
                                                                            <i class="fa fa-facebook fa-stack-1x fa-inverse text-orange"></i>
                                                                            <span class="mytooltip">Facebook</span>                    
                                                                        </span> 
                                                                    </li>
                                                                    <li class="pointer tencent-weibo">
                                                                        <span class="fa-stack">
                                                                            <i class="fa fa-circle fa-stack-2x text-white"></i>
                                                                            <i class="fa fa-tencent-weibo fa-stack-1x fa-inverse text-orange"></i>
                                                                            <span class="mytooltip">Tencent Weibo</span>      
                                                                        </span> 
                                                                    </li>
                                                                    <li class="pointer google-plus">
                                                                        <span class="fa-stack">
                                                                            <i class="fa fa-circle fa-stack-2x text-white"></i>
                                                                            <i class="fa fa-google-plus fa-stack-1x fa-inverse text-orange"></i>
                                                                            <span class="mytooltip">Google Plus</span>      
                                                                        </span> 
                                                                    </li>
                                                                    <li class="pointer youtube">
                                                                        <span class="fa-stack">
                                                                            <i class="fa fa-circle fa-stack-2x text-white"></i>
                                                                            <i class="fa fa-youtube fa-stack-1x fa-inverse text-orange"></i>
                                                                            <span class="mytooltip">Youtube</span>      
                                                                        </span> 
                                                                    </li>
                                                                    <li class="pointer linkedin">
                                                                        <span class="fa-stack">
                                                                            <i class="fa fa-circle fa-stack-2x text-white"></i>
                                                                            <i class="fa fa-linkedin fa-stack-1x fa-inverse text-orange"></i>
                                                                            <span class="mytooltip">Linkedin</span>      
                                                                        </span> 
                                                                    </li>
                                                                    <li class="pointer instagram">
                                                                        <span class="fa-stack">
                                                                            <i class="fa fa-circle fa-stack-2x text-white"></i>
                                                                            <i class="fa fa-instagram fa-stack-1x fa-inverse text-orange"></i>
                                                                            <span class="mytooltip">Instagram</span>      
                                                                        </span> 
                                                                    </li>
                                                                </ul>

                                                                <a class="link-suntory" href="http://suntorydesign.net/" target="blank">
                                                                    <p>2014 Designed by Suntory Design & Consulting</p>
                                                                </a>
                                                    ...
                                                    <script type="text/javascript" src="<?php echo ASSETS ?>plugins/jquery-number/jquery.number.min.js"></script>
                                                    ...
                                                    <script type="text/javascript">
                                                                        ...
                                                                        $(function () {
																			...
																			$('#client_birthday, #client_birth').datepicker({
...
?>';
                                                        var REQUEST_LOGIN = "<?php 
if(isset($_SESSION['request_login'])) {
    echo $_SESSION['request_login'];
} else { 
    echo '';
}
?>";
                                                    ...
                                                    <script type="text/javascript">
                                                        /////// imtoantran dynamic load slicer by id //// rev_slider_id 
                                                        // jQuery(document).ready(function ($) {
                                                            function load_revslider() {
                                                                $.each($(".revslider"), function (index, slider) {
                                                                    /* iterate through array or object */
                                                                    rev_id = $(slider).attr('id').replace('rev_slider_', '');
                                                                    $.ajax({
                                                                        url: URL + 'revslider/index/' + rev_id,
                                                                        type: 'POST',
                                                                        data: {slider_id: rev_id},
                                                                    })
                                                                            .done(function (data) {
                                                                                $("#rev_slider_" + rev_id).html(data);
