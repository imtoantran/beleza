...
<head>
    <meta charset="utf-8" />
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo ASSETS ?>plugins/rs-plugin/css/navstylechange.css" media="screen" />
        <!-- imtoantran add slider css -->
                            ...
                            <div class="col-sm-12 remove-padding" style="margin-bottom: 10px;">
                                <div class="dropdown"> 
                                    <a id="dropdown_profile" data-toggle="dropdown" class="btn btn-orange-black btn-block dropdown-toggle"> 
                                        Xin chào: <i class="fa fa-user"></i> <?php echo $_SESSION['client_name']; ?> <span class="caret"></span>
                                    </a>
                                    <ul style="border-radius: 0px;" class="dropdown-menu pull-right" role="menu" aria-labelledby="dropdown_profile">
                                        ...
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo URL . 'bookinghistory'; ?>"><i class="fa fa-history"></i> Lịch sử đặt hẹn</a></li>
                                        <li role="presentation" class="divider" style="border: 1px"></li>
