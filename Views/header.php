...
<head>
    ...
    <title>Beleza Healthy and Beauty Marketplace</title>
    ...
    <!-- imtoantran add slider css -->
    <link rel="stylesheet" type="text/css" href="<?php echo ASSETS ?>plugins/rs-plugin/css/navstylechange.css"
          media="screen"/>
    <!-- imtoantran add slider css -->
    <!-- SLIDER REVOLUTION 4.x CSS SETTINGS -->
    <link rel="stylesheet" type="text/css" href="<?php echo ASSETS ?>plugins/rs-plugin/css/settings.css"
          media="screen"/>
    <!-- imtoantran add css -->
    <link rel="stylesheet" type="text/css" href="<?php echo ASSETS ?>css/toan.css" media="screen"/>
    <!-- imtoantran add css -->
    <link rel="stylesheet" type="text/css" href="<?php echo ASSETS ?>css/fix-css-hoa.css" type="text/css"/>
    <?php
    if (isset($this->style)) {
    ...
    // luuhoabk - embed script
    if (isset($this->embedScript)) {
        foreach ($this->embedScript as $script) {
...
<header id="header" class="container">
    <div id="top-header" class="clearfix">
        <div id="top-header-left" class="col-md-3">
            <button onclick="clearCreatePlaceModal()" class="btn create-location-btn" data-toggle="modal"
                    data-target="#create_place_modal" type="button"><i class="fa fa-plus"></i> Tạo địa điểm
            </button>
        </div>
        ...
        <div id="top-header-right" class="col-md-3">
            <div class="clearfix" id="login_group">
                ...
                if (empty($_SESSION['client_id'])) {
                    ...
                    <div class="col-sm-5 remove-padding">
                        <button id="login_btn" onclick="setTimeIdle()" class="btn btn-block login-btn"
                                data-toggle="modal" data-target="#login_modal" type="button">Đăng nhập
                        </button>
                    </div>
                ...
                <?php } else { ?>
                    <div class="col-sm-12 remove-padding" style="margin-bottom: 10px;">
                        <div class="dropdown">
                            <a id="dropdown_profile" data-toggle="dropdown"
                               class="btn btn-orange-black btn-block dropdown-toggle">
                                Xin chào: <i class="fa fa-user"></i> <?php echo $_SESSION['client_name']; ?> <span
                                    class="caret"></span>
                            </a>
                            <ul style="border-radius: 0px;" class="dropdown-menu pull-right" role="menu"
                                aria-labelledby="dropdown_profile">
                                <li role="presentation"><a role="menuitem" tabindex="-1"
                                                           href="<?php echo URL . 'clientsetting'; ?>"><i
                                            class="fa fa-wrench"></i> Quản lý tài khoản</a></li>
                                <li role="presentation" class="divider" style="border: 1px"></li>
                                <li role="presentation">
                                    <a role="menuitem" tabindex="-1" href="<?php echo URL . 'bookinghistory'; ?>">
            ...
            <div class="col-md-12 remove-padding clearfix">
                ...
                <input style="position: relative;padding-left: 30px" type="text"
                       class="form-control search-global empty" placeHolder="Gõ nội dung cần tìm...">
            </div>
        </div>
    </div>
    <!-- END TOP HEADER -->
        ...
        <nav class="navbar navbar-default" role="navigation">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul id="menu_home" class="nav navbar-nav navbar-left" style="font-weight: 600;">
                    ...
                    <div class="navbar-form navbar-right">
                        ...
                        <button style="padding: 0 4px;" onclick="shoppingCartDetail()" type="submit"
                                class="btn btn-sm btn-default btn-cart-shop">
                                    ...
                                    <span id="booking_amount" class="fa fa-stack">
                                        ...
                                        <b class="fa-stack-1x text-white" style="font-size: 11px;">
                                            ...
                                            if (isset($_SESSION['gift_detail'])) {
                                                $gift_count = count($_SESSION['gift_detail']);
                                            }
                                            echo $booking_count + $eVoucher_count + $gift_count;
                                            ?>
                                        </b>
                                    </span>
                        </button>
    ...
    <!-- END NAVIGATION -->
    <div id="create_place_modal" style="z-index: 1051;" class="modal fade" role="dialog" aria-labelledby="myModalLabel"
         aria-hidden="true" data-backdrop="static" data-max-height="440">
        <div class="modal-dialog">
            <div class="modal-content" style="border-radius: 0px;">
                <div class="modal-header" style="background-color: #FDBD0E; padding: 6px 10px;">
                    ...
                    <h5 class="modal-title" id="myModalLabel" style="text-align:center; font-weight:bold;">GỬI YÊU CẦU
                        TẠO ĐỊA ĐIỂM</h5>
                </div>
                <div class="modal-body" style="padding: 30px 20px 0px;">
                    <form class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input autocomplete="off" class="form-control" type="text" id="create_place_name"
                                       name="create_place_name" placeholder="Nhập họ tên..."/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input autocomplete="off" class="form-control" type="text" id="create_place_email"
                                       name="create_place_email" placeholder="Nhập email...VD:abc@example.com"/>
                                <small style="color: red;"></small>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input onkeypress="inputNumbers(event)" autocomplete="off" class="form-control"
                                       type="text" id="create_place_phone" name="create_place_phone"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input autocomplete="off" class="form-control" type="text" id="create_place_address"
                                       name="create_place_address"
                                       placeholder="Địa chỉ (Hãy nhập đầy đủ quận, huyện)..."/>
                                <small style="color: red;"></small>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-3">Thành Phố</label>

                            <div class="col-sm-8">
                                <select style="color: #777;" id="create_place_city" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input autocomplete="off" class="form-control" type="text" id="create_place_com_name"
                                       name="create_place_com_name" placeholder="Nhập tên công ty bạn muốn đặt..."/>
                                <small style="color: red;"></small>
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-footer" id="create_place_footer" style="padding: 15px 20px 15px;">
                    <small style="display: none;color: red;" id="error_message_create_place"><i>Email không hợp lệ </i>
                    </small>
                    <button type="button" id="create_place_btn" onclick="sendCreatePlaceMail()"
                            class="btn btn-sm btn-orange-black">
                        <i style="display: none" id="waiting_for_create_place" class="fa fa-refresh fa-spin"></i> Gửi
                        mail
                    </button>
...
<div class="shadow-head-bottom"></div>
