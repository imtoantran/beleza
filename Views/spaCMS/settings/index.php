									...
									<div class="form-venue-details">
										<div class="venue-main-info">
											...
											<table cellspacing="0" cellpadding="0" class="default-form">
												<tbody>
													<tr id="venue_name" title="&lt;strong&gt;Tên địa địa điểm&lt;/strong&gt; - Nhập tên địa điểm của bạn." class="form-row" aria-describedby="ui-tooltip-0">
														<td colspan="2">
													...
													<tr id="venue_type" title="&lt;strong&gt;Slogan&lt;/strong&gt; - Nhập Slogan của bạn." class="form-row" aria-describedby="ui-tooltip-1">
														<td class="label-part"><label for="user_business_id">Slogan</label></td>
														<td class="input-part">
														<input id="user_type_business" type="text" name="user_type_business" class="" maxlength="55"></td>
										...
										<table cellspacing="0" cellpadding="0" class="default-form">
											<tbody>
												...
												<tr id="venue_address" title="&lt;strong&gt;Địa chỉ&lt;/strong&gt; - Nhập địa chỉ của bạn" class="form-row" aria-describedby="ui-tooltip-4">
												...
												<tr class="form-row">
													<td class="label-part"><label for="user_city_id">Tỉnh Thành</label></td>
													<td class="input-part">
														<select id="user_city_id" name="user_city_id" class="required">
															<option value="0">Chưa chọn</option>
														</select>
														-
														<label for="user_district_id">Quận/Huyện</label>
														<select id="user_district_id" name="user_district_id" class="required">
															<option value="0">Chưa chọn</option>
														</select>
													</td>
												</tr>
												<tr id="loc_map" title="&lt;strong&gt;Vị trí trên bản đồ&lt;/strong&gt; - Click vào bản đồ để xem chính xác vị trí của bạn trên bản đồ." class="form-row">
													...
													<td class="input-part">
														<div class="location-map-wrapper">
															...
															<div class="edit">
																<a id="btnOM_editUserMap" class="edit-location" href="javascript:;">Sửa<a href=""></a></a>
															</div>
														</div>
												...
												<tr id="phone" title="&lt;strong&gt;Số điện thoại&lt;/strong&gt; - Nhập số điện thoại." class="form-row">
												...
												<tr id="email" title="&lt;strong&gt;Email&lt;/strong&gt; - Nhập địa chỉ email." class="form-row">
												...
												<tr id="website" title="&lt;strong&gt;Website&lt;/strong&gt; - Nhập địa chỉ website." class="form-row">
												...
												<tr id="face" title="&lt;strong&gt;Facebook&lt;/strong&gt; - Nhập địa chỉ Facebook." class="form-row">
												...
												<tr id="google" title="&lt;strong&gt;Google+&lt;/strong&gt; - Nhập địa chỉ Google+." class="form-row">
												...
												<tr id="description" title="&lt;strong&gt;Mô tả dịch vụ&lt;/strong&gt; - Nhập mô tả dịch vụ." class="form-header-row">
								...
								<table cellspacing="0" cellpadding="0" class="default-form">
									<tbody>
										<tr data-tooltip="&lt;strong&gt;Lead time&lt;/strong&gt; - Set how soon the first time slot is available for online bookings. Bigger values prevent last minute bookings." class="form-row">
											...
											<td class="input-part">
												<select id="booking-settings-onlineBookingMinHours" data-time-before-service="<?php echo TIME_BEFORE_SERVICE; ?>" name="user_limit_before_service" class="required ">
													<option value="60">1 tiếng</option><option value="120">2 tiếng</option><option value="180">3 tiếng</option><option value="240">4 tiếng</option><option value="300">5 tiếng</option><option value="360">6 tiếng</option><option value="420">7 tiếng</option><option value="480">8 tiếng</option><option value="1440">1 ngày</option><option value="2880">2 ngày</option><option value="4320">3 ngày</option><option value="7200">5 ngày</option><option value="10080">1 tuần</option><option value="20160">2 tuần</option><option value="30240">3 tuần</option><option value="40320">4 tuần</option>
												</select>
											</td>
										</tr>
										<tr>
											<td></td>
											<td style="font-size: 0.9em; color: #a7a7a7; font-style: italic;"><i class="fa fa-info"></i> Thời gian tối thiểu trước dịch vụ của hệ thông quy định là: <?php echo TIME_BEFORE_SERVICE; ?> phút</td>
										</tr>
										<tr data-tooltip="&lt;strong&gt;Lead time&lt;/strong&gt; - Set how soon the first time slot is available for online bookings. Bigger values prevent last minute bookings." class="form-row">
											<td class="label-part"><label for="booking-settings-onlineBookingMinHours">Thời gian tự động xác thực</label></td>
											<td class="input-part">
											<select id="booking-settings-autoConfirm" name="user_limit_auto_confirm" class="required">
												<option value="0"> Xác thực luôn</option>
												<?php
												$nTimeBefor= TIME_AUTO_CONFIRM/15;
												for($i=1;$i<=$nTimeBefor;$i++){
													?>
													<option value="<?php echo($i*15);?>"> <?php echo ($i*15).' phút sau';?></option>
												<?php
												}
												?>
<!--												<option value="0">Luôn xác thực</option><option value="60">1 tiếng</option><option value="120">2 tiếng</option><option value="180">3 tiếng</option><option value="240">4 tiếng</option><option value="300">5 tiếng</option><option value="360">6 tiếng</option><option value="420">7 tiếng</option><option value="480">8 tiếng</option><option value="1440">1 ngày</option><option value="2880">2 ngày</option><option value="4320">3 ngày</option><option value="7200">5 ngày</option><option value="10080">1 tuần</option><option value="20160">2 tuần</option><option value="30240">3 tuần</option><option value="40320">4 tuần</option>-->
											</select></td>
										</tr>
										<tr data-tooltip="&lt;strong&gt;Thiết lập dịch vụ limit&lt;/strong&gt; - Set how far in future your clients can book online." class="form-row">
											...
											<td class="input-part">
												...
												<span class="help-txt">ngày trong tương lai</span>
											</td>
										</tr>										
										<tr class="form-row">
											<td class="label-part">
				...
				<form id="editUserMap_form" action="#" method="POST">
					<div class="dialog-content clearfix">
						...
						<div id="venue-details-map-info">
							<div id="venue-details-map-address" class="b-full-address">
								<div class="part-title">Địa chỉ</div>
								<!-- <input type="text" size="30" name="address" value="3 cit&eacute; Nollez Paris France" /> -->
								<textarea id="address_for_find" cols="27" rows="3" style="resize: none">186A2 Man Thiện, Q.9, TP.HCM</textarea>
								<button id="btnAct_find_address_on_map" class="button button-basic a-geocode">
