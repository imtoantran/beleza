								...
								<table cellspacing="0" cellpadding="0" class="default-form">
									<tbody>
										<tr class="form-row">
											<td class="label-part"><label for="cat-name" style="padding-top: 3px;">Tên nhóm dịch vụ</label></td>
											<td class="input-part">
												<input type="text" id="group_service_name" name="group_service_name" style="width:350px" required placeHolder="Nhập tên nhóm dịch vụ">
											</td>
										</tr>
									</tbody>
								</table>
						...
						<div class="dialog-content clearfix">
							<div class="offer-form-main">
								<div class="offer-type">
									...
									<div id="service_name" title="<strong>Tên dịch vụ</strong> - Hãy nhập tên dịch vụ. Tránh sử dụng giá cả hoặc tỷ lệ chiết khấu trong tên dịch vụ. Hệ thống dùng để tính toán và hiển thị dựa theo thông tin giá cả bên dưới. " class="tooltips tooltips-bottom b-select-valid txt-input txt-input-big form-element-wrapper" aria-describedby="ui-tooltip-1">
								...
								<div tabindex="-1" class="offer-content">
										...
										<div class="single-sku-container">
											<table cellspacing="0" cellpadding="0" class="default-form skus-edit">
												<tbody>
													...
													<tr id="price" title="- <strong>Giá gốc: </strong>là giá dịch vụ của bạn. </br>- <strong>Giá khuyến mãi: </strong> là giá sau khi giảm." class="form-row" aria-describedby="ui-tooltip-5">
									...
									<div class="listing group-dependancy">
										<h2 class="part-title">Hình thức kinh doanh cho dịch vụ này</h2>
										<div id="sell_service" title="<strong>Tính năng nổi bật trên Beleza</strong> - Hệ thống lựa ra 5 dịch vụ mà bạn đã chọn làm nổi bật để hiển thị ra bên ngoài trang Beleza. Tạo đặc trưng và điểm nhấn về những dịch vụ của bạn." class="choices form-element-wrapper enhanced-listing-only">
											<label>
										...
										<div class="fullfilment">
											<div class="empty standard-listing hidden">
												...
												<p class="after-txt">
													Bạn có biết bây giờ bạn có thể bán trên Beleza hôm nay?
												</p>
											...
											<table cellspacing="0" cellpadding="0" class="fulfillment-edit">
												<tbody>
													...
													<tr id="sold_as" title="- <strong>Appointment</strong> (cuộc hẹn): khách hàng đặt trực tiếp bằng cách chọn vào lịch hoạt động của dịch vụ. </br>- <strong><em>eVoucher</em></strong> - Khách hàng nhận được eVoucher từ đó họ có thể thanh toán trên dịch vụ của bạn." class="form-row">
									...
									<div class="descriptions group-dependancy">
										<div class="txts description">
											...
											<!-- bb code -->
											<textarea max-text-lines="4" id="user_description_add" name="user_service_description" cols="5" rows="4" class="full required"></textarea>
										</div>
									</div>
								</div>
								...
								<div tabindex="-1" class="offer-content">
										...
										<div class="fullfilment">
											...
											<table cellspacing="0" cellpadding="0" class="fulfillment-edit">
												<tbody>
													...
													<tr id="booking_limit" title="<strong>Giới hạn book</strong> - Giới hạn số lượt book cho dịch vụ trong khoảng giờ" class="form-row">
														<td class="label-part"><label >Giới hạn đặt</label></td>
														<td>
									...
									<div class="descriptions group-dependancy">
										<div class="txts description">
											<h2 class="part-title">Mô tả dịch vụ</h2>
											<!-- bb code -->
											<textarea max-text-lines="4" id="user_description_edit" name="user_service_description" cols="5" rows="4" class="full required"></textarea>
										</div>
									</div>
								</div>
								<div class="top-shadow"></div>
