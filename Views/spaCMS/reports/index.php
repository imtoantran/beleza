        ...
        <div class="section-aside">
            <ul id="nav2" class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" role="tablist">
                <li class="ui-state-default ui-corner-top active" id="bookings-tab" style="display: list-item;">
                    <a href="#clients" style="position: relative;" role="tab" data-toggle="tab">
                        <div class="title vertically-centered" style="width:170px; position: absolute; height: 17px; top: 50%; margin-top: -8.5px;">Danh sách Khách hàng</div>
                    </a>
                </li>
                <li class="ui-state-default ui-corner-top" id="bookings-tab" style="display: list-item;">
                ...
                <li class="ui-state-default ui-corner-top hidden" id="appointments-tab" style="display: list-item;">
                    <a href="#appointments" style="position: relative;" role="tab" data-toggle="tab">
                        <div class="title vertically-centered" style="position: absolute; height: 17px; top: 50%; margin-top: -8.5px;">D/s Cuộc hẹn ngoài</div>
                    </a>
                </li>
                <li class="ui-state-default ui-corner-top" id="giftvouchers-tab" style="display: list-item;">
                    <a href="#giftvouchers" style="position: relative;" role="tab" data-toggle="tab">
                        <div class="title vertically-centered" style="position: absolute; height: 17px; top: 50%; margin-top: -8.5px;">D/s Gift-voucher</div>
                    </a>
                </li>
        ...
        <div class="tab-content section-main ui-widget-content ui-corner-bottom">
            ...
            <div class="tab-pane active" id="clients">
                <div class="reports-clients">
                    <div class="home-filters" style="background-color: #EAEBE4;">
                        <div class="" id="filter-type">
                            <button id="clients_reports_export_excel" type="button" class="btn btn-primary">
                                <div class="fa fa-file-text done"></div>
                                Excel
                            </button>
                        </div>
                    </div>
                    <div class="home-data" style="padding: 20px;">
                        <div class="portlet-body" style="margin-bottom: 30px">
                            <div class="table-container">
                                <table class="table table-bordered table-hover" id="reportClients_table" >
            ...
            <div class="tab-pane" id="bookings">
                <div class="reports-bookings">
                    <div class="home-filters">
                        <div class="" id="filter-type">
                            <button id="bookings_reports_export_excel" type="button" class="btn btn-primary">
                                <div class="fa fa-file-text done"></div>
                                Excel
                            </button>
                        </div>
            ...
            <div class="tab-pane" id="evouchers">
                <div class="reports-evouchers">
                    <div class="home-filters">
                        <div class="" id="filter-type">
                            <button id="evouchers_reports_export_excel" type="button" class="btn btn-primary">
            ...
            <div class="tab-pane" id="appointments">
                <div class="reports-appointments">
                    <div class="home-filters">
                        <div class="" id="filter-type">
                            <button id="appointments_reports_export_excel" type="button" class="btn btn-primary">
                            <i class="fa fa-file-text"></i> Excel
                            </button>
                        </div>
                    </div>
                    <div class="home-data">
                        <div class="portlet-body" style="margin-bottom: 30px">
                            <div class="table-container">
                                <table class="table table-bordered table-hover" id="listOfAppointment_table" >
                                    <thead style="background-color: #428CCC;">
                                        <tr>
                                            <th>
                                                Appointment id </br>
            ...
            <!-- Gift voucher -->
            <div class="tab-pane" id="giftvouchers">
                <div class="reports-giftvouchers">
                    <div class="home-filters">
                        <div class="" id="filter-type">
                            <button id="giftvouchers_reports_export_excel" type="button" class="btn btn-primary">
                            <i class="fa fa-file-text"></i> Excel
                            </button>
                        </div>
                    </div>
                    <div class="home-data">
                        <div class="portlet-body" style="margin-bottom: 30px">
                            <div class="table-container">
                                <table class="table table-bordered table-hover" id="listOfGiftvoucher_table" >
                                    <thead style="background-color: #428CCC;">
                                        <tr>
                                            <th>
                                                Gift id </br>
            ...
            <div class="tab-pane" id="sales">
                ...
                <div class="report-content">
                    ...
                    <h1>Tổng doanh số bán hàng <small>- Booking + Evoucher + Gift-voucher</small></h1>
                    <h2 class="spa_name"><?php echo Session::get('user_business_name');?></h2>
                    ...
                    <div id="sales_booking">
                        <div class="" align="center" style="font-weight: 700; font-size: 17px;">
                            <span style="background-color: #E6E6E6; padding: 5px 40px;">BOOKING</span>
                        </div>
                        <div class="stats-group">
                            <table class="sale_report_by_service_group">
                                <thead>
                                    <tr>
                        ...
                        <div class="stats-group">
                            <table class="sale_report_top_service">
                                <thead>
                                    <tr>
                    ...
                    <br><br>
                    <div id="sales_evoucher">
                        <div class="" align="center" style="font-weight: 700; font-size: 17px;">
                            <span style="background-color: #E6E6E6; padding: 5px 30px;">E-VOUCHER</span>
                        </div>
                        <div class="stats-group">
                            <table class="sale_report_by_service_group">
                                <thead>
