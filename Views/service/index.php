...
<div id="content-wrap">
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="pull-right">
										<i id="waiting_for_review" style="display: none" class="fa fa-refresh fa-spin"></i> 
										<button onclick="sendReview()" id="send_review" type="button" class="btn btn-sm btn-orange">Gửi đánh giá</button>
									</div>
								</div>						
							</div>
						</div>
							...
							<div class="row">
								<div class="col-md-12">
									<span class="fa-stack fa-3x">
										...
										<img id="use_appointment" src = '<?php print URL; ?>Views/service/images/slash.png'/>
										<!-- imtoantran style evoucher button -->
									</span>
								</div>
								<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-12">
									<span class="fa-stack fa-3x">
										...
										<!-- imtoantran style evoucher button -->
										<img id="use_e_voucher" src = '<?php print URL; ?>Views/service/images/slash.png'/>
										<!-- imtoantran style evoucher button -->
									</span>
								</div>
								<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-12">
									<span class="fa-stack fa-3x">
										...
										<!-- imtoantran style evoucher button -->
										<img id="use_gift_voucher" src = '<?php print URL; ?>Views/service/images/slash.png'/>
										<!-- imtoantran style evoucher button -->
									</span>
								</div>
								<div class="col-md-12">
			...
			<div style="margin-top: 15px;" class="row">
				...
				<div class="col-md-12">
					<h4 class="text-center" style="margin: 5px 0 5px 0;">
						<i class="fa fa-users fa-lg text-orange"></i> Tổng số truy cập: <b><span id="user_total_view">...</span></b> lượt
					</h4>
				</div>
			</div>
			<div class="divider"></div>
    ...
    <div id="info-promotion" class="modal fade in" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" style="display: none;">
    	<div class="modal-dialog modal-lg">
    		<div class="modal-content" style="border-radius:0;">
    			<div class="modal-header" style="background-color: #FDBD0E; padding: 6px 10px;">
		      	...
		      	<div id="promotion-item-content-wrapper" class="modal-body" style="min-height:400px">
		      		<div class="row-fluid" style="font-size: 1.2em; font-weight: 600; color: #4f4f4f;">
		      			<span style="padding: 1px 7px; background-color: #fdbd0e; border-radius: 100%;"><i class="fa fa-stack-exchange"></i></span>
		      			<span class="promotion-item-title" style="border-bottom: 1px solid #ffcc00; padding: 0 5px 0px 20px; margin-left: -20px;">
		      				<!-- title -->
		      			</span>
	      			</div>
	      			
	      			<div class="row-fluid" style="padding: 9px 0px 5px 30px; color:#4f4f4f">	      				
      					<i class="fa fa-calendar"> </i> <span style="color: #aaa;" class="promotion-item-start-date">...</span> 
      					<i class="fa fa-long-arrow-right"> </i> <span style="color: #aaa;" class="promotion-item-end-date">...</span>
	      			</div>     				
