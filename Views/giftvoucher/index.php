...
<div id="content-wrap" >
		...
		<div class="choice-voucher">
			<div class="choice-voucher-wrap clearfix">
				...
				<div class="row" align="center">
					<ul class="list-inline" align="center" id="gift_price_list">
						<!--<li>	
	...
	<div id="gift-voucher-3" class="container">
		<p id="page_giftvoucher_thongtin" class="title" align="center"></p>
		<div class="list-aq clearfix">
			<div id="page_giftvoucher_block1" class="col-sm-6" style="border-right: 2px solid #CCC;">
				
			</div>
			<div id="page_giftvoucher_block2" class="col-sm-6">
				...
				<div class="modal-body" style="padding: 30px 20px 0px;">
					<form class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input autocomplete="off" class="form-control" type="text" id="gift_sender" name="gift_sender" placeholder="Họ tên người nhận..." />
								<small style="color: red;"></small>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-3">Email người nhận</label>
							<div class="col-sm-8">
						...
						<!-- luuhoabk -->
						<div class="box-gifcard" style="display: none">
							<div class="form-group">
								<label class="control-label col-sm-3">Địa chỉ</label>
								<div class="col-sm-8">
									<input autocomplete="off" class="form-control" type="text" id="gift_address" name="gift_address" placeholder="Địa chỉ người nhận." />
									<small style="color: red;"></small>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input autocomplete="off" class="form-control" type="text" id="gift_phone" name="gift_phone" placeholder="Điện thoại người nhận." />
									<small style="color: red;"></small>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8" >
								...
								<select class="form-control" style="padding-top: 8px;" id="gift_value">
