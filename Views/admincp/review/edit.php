...
<div class="modal fade" id="modal-reply">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-xs-12">
						<div>
							<strong  class="text-primary modal-title"></strong>: <span id="reply-content" data-id="" data-status=""></span>
						</div>
					</div>
				</div>
			</div>
...
</div><!-- /.modal --><div id="home-holder" class="content-holder pending">
	<div class="sidebar">
	...
	<div class="main-content" id="main_detail">
			...
			<div class="col-md-12">
				<div class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-md-7">
							<input disabled="disabled" placeholder="Nhập tên người dùng..." class="form-control" id="client_name" name="" type="text" readonly="readonly" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-7">
							<input disabled="disabled" placeholder="Nhập ngày tham gia..." class="form-control" id="client_join_date" name="" type="text"/>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-3">Đánh Giá Trên Địa Điểm</label>
						<div class="col-md-7">
							<input disabled="disabled" placeholder="Nhập địa điểm..." class="form-control" id="user_business_name" name="" type="text"/>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-3">Nội Dung</label>
						<div class="col-md-7">
							<textarea style="min-width: 100%;max-width: 100%; min-height: 120px;" class="form-control" disabled="disabled" id="user_review_content"></textarea>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-md-12">
				<button disabled="disabled" onclick="editReview()" id="btn_edit_review" type="button" class="button action action-default button-other save-action">
					<div class="button-inner">
				...
				<button style="display: none;" onclick="deleteReview()" id="btn_delete_review" type="button" class="button action action-default button-secondary save-action">
					<div class="button-inner">
						  ...
						  <table class="table table-bordered table-hover" id="replies_list">
							  ...
							  <?php foreach($replies as $key=>$reply): ?>
								  <tr data-id="<?php echo $reply['id'] ?>">
									  ...
									  <td><span class="label <?php if($reply['status_code']=='verified') echo "status-confirmed"; else if($reply['status_code']=='reported') echo "note-critical"; else if($reply['status_code']=='auto') echo "label-quiet"; else echo "status-not-confirmed";?>"><?php echo $reply['status'] ?></span></td>
								  </tr>
							  <?php endforeach; ?>
							  </tbody>
						  </table>
