<div id="home-holder" class="content-holder pending">
	...
	<div class="main-content">
		<h3 class="add-place">Thêm một thành phố</h3>
		<hr />
		<div class="row">
			<div class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-md-7">
						<input placeholder="Nhập tên quận..." class="form-control" id="city_name" name="" type="text"/>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12">
				<button onclick="saveCity()" type="button" class="button action action-default button-primary save-action">
					<div class="button-inner">
				...
				<small id="error_add_city" style="color: red; display: none;">Nhập đầy đủ các trường có (*)</small>
			</div>
		</div>
	</div>
</div>
