<div id="home-holder" class="content-holder pending">
	...
	<div class="main-content">
		<h3 class="add-place">Thêm một loại dịch vụ</h3>
		<hr />
		<div class="row">
		...
		<div class="row">
			<div class="col-md-12">
				<button onclick="saveServiceType()" type="button" class="button action action-default button-primary save-action">
					<div class="button-inner">
				...
				<small id="error_add_service_type" style="color: red; display: none;">Nhập đầy đủ các trường có (*)</small>
			</div>
		</div>
	</div>
