<div id="home-holder" class="content-holder pending">
	<div class="sidebar">
		<div class="venue-info">
			<div class="title-admincp">Chỉnh sửa Menu</div>
			<button onclick="returnToMenu()" id="" class="btn btn-primary button redeem" type="button">
    ...
    <div class="main-content">
        <div class="content-menu-title">CHỈNH SỬA MENU</div>
        <hr />
        <div class="row">
                        ...
                        <div id="box-upload" class="form-group" style="display:none">
                            ...
                            <div class="col-md-8">
                                <form id="upload_form" method="post" name="upload_image" enctype="multipart/form-data">
                                    <input class="btn btn-default" style="width:100%" id="menu_background" data-url="" name="menu_background"  value="upload" type="file" />
                                    <input class="btn btn-warning text-center" id="upload_image"  value="Upload" name="submit" type="submit" style="margin-top:5px;"/>
                                    <input class="btn btn-black text-center" id="change_image"  value="Thay đổi" name="submit" type="button" onclick="getListImage()" style="margin-top:5px;"/>
                                </form>
        ...
        <div class="row">
            <div class="col-md-12">
                <button onclick="updateSaveItemMenu();" type="button" class="button btn btn-success action action-default save-action">
                    <div class="button-inner">
                        <div class="button-icon icons-tick done"></div>
                        <div class="button-icon fa fa-spin fa-refresh s-loading"></div>
                        <span class="msg msg-action-default">Chỉnh sửa</span>
                    </div>
                </button>
                <button onclick="addNewMenu()" type="button" class="btn btn-border-radius-none button action action-default save-action">
                    <div class="button-inner">
...
<script>
	var IS_ADD = 0;
	var IS_EDIT = 1;
        var MENU_ID = "<?php echo $this -> menu_id; ?>";
</script>